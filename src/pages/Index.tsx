    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center p-8 bg-gradient-to-b from-white to-gray-100">
        ...
        <p className="mt-6 text-sm text-gray-500">
          Powered by Supabase • Secure and scalable backend
        </p>
      </div>
      ...
      <div className="bg-gray-50 py-16 px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">Next Steps with Supabase</h2>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ol className="list-decimal pl-6 space-y-4">
              <li className="text-gray-800">
                <span className="font-semibold">Create database tables</span>: Set up tables for users, students, homework, exams, attendance, fees, and performance.
              </li>
              <li className="text-gray-800">
                <span className="font-semibold">Configure authentication</span>: Set up email/password authentication for tutors and parents.
              </li>
              <li className="text-gray-800">
                <span className="font-semibold">Update API client</span>: Connect your frontend to Supabase by updating the API client with your Supabase credentials.
              </li>
              <li className="text-gray-800">
                <span className="font-semibold">Set up Row Level Security</span>: Ensure tutors can only access their own students and parents can only access their own children.
              </li>
            </ol>
